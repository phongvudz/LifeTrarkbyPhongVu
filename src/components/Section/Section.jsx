        ...
        <div className="flex justify-between items-end  bg-white rounded-xl lg:max-w-xl xl:max-w-2xl mx-auto ">
          <div className="w-80 py-[20px] px-[25px]  ">
            ...
            <p className="text-gray-600 leading-loose ">
              Explain to you how all this mistaken idea of denouncing tis
              pleasure and praising pain was born and I will give you a complete
              praising the account is account the.{" "}
            </p>
          ...
          <div>
              <img  src="https://demo.themefisher.com/lifetrakr/images/testimonial/review-person-one.png" alt="people like"/>
          </div>
        </div>
      </section>
    </div>
